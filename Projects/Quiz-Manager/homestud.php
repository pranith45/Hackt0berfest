...
<body style="color: #fff !important;font-weight:bolder;margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;">
    <div style="background-color:#152640;height: auto;">
        ...
        ?>
        <center><section style="width:100vw;margin:0vw;margin-top:5vw;font-size:3vw;">Welcome to Online Quiz System&nbsp;<?php echo $dbname ?></section></center>
...
"function dash(){".
    ...
    "}".
"function lo(){".
"alert(\"Thank You for Using our Online Quiz System\");";
//session_unset();
//session_destroy();
